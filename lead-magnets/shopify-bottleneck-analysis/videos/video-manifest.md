...
| Healthy / No Major Bottleneck | `healthy` | `scripts/04-healthy.md` | `shopifyBottleneckVideoIds.healthy` | Rewritten first draft ready; review pending |
