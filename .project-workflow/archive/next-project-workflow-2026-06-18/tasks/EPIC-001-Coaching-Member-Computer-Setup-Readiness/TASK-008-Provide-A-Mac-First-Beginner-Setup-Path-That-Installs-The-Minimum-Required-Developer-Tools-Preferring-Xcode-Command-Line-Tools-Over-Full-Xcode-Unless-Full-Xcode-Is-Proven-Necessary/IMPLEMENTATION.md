...
- [x] AC1: Mac setup guidance prefers Command Line Tools over full Xcode unless the model explains a real need.
- [x] AC2: NVM and Node.js setup is handled through copyable model prompts, not raw member-run install instructions.
- [x] AC3: Shopify CLI setup is gated behind Node, npm, and Git verification.

## Validation

- AC2 / parent evidence: AC2: Module 1 now includes Mac command-line tools, NVM/Node, and Shopify CLI install/verification steps with model-operated prompts and full-Xcode avoidance.
...
- AC2: AC2: Module 1 now includes Mac command-line tools, NVM/Node, and Shopify CLI install/verification steps with model-operated prompts and full-Xcode avoidance.
