...
- [x] AC1: Version checks are visible in Module 1 setup prompts and done-when criteria.
- [x] AC2: Module 2 re-checks all required commands before theme work.
- [x] AC3: Missing tools route the member back to Module 1.

## Validation

- AC5 / parent evidence: AC5: Mac setup prompts and Module 2 local tooling prompt now include exact command verification output requirements.
...
- AC5: AC5: Mac setup prompts and Module 2 local tooling prompt now include exact command verification output requirements.
