...
- [x] AC1: Inspection, access education, Mac tools, NVM/Node, Shopify CLI, and setup summary prompts are present.
- [x] AC2: Prompts include approval and verification instructions.
- [x] AC3: The UI copy button pattern is reused for every prompt.

## Validation

- AC9 / parent evidence: AC9: Module 1 contains exact copyable prompts for readiness inspection, access education, Mac tools, NVM/Node, Shopify CLI, and final setup summary.
...
- AC9: AC9: Module 1 contains exact copyable prompts for readiness inspection, access education, Mac tools, NVM/Node, Shopify CLI, and final setup summary.
